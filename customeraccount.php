									...
									<div class="snipcart-item block border">
										...
										<div class="snipcart-details border">
											<form action="selectcategory.php" method="post">
												<fieldset>
													<center style="padding-top: 10px;"><input type="submit" value="Sell Property" class="btn btn-info" /></center>
												</fieldset>
											</form>
										</div>
									</div>
									...
									<div class="snipcart-item block border">
										...
										<div class="snipcart-details border">
											<form action="viewproduct.php" method="post">
												<fieldset>
													<center style="padding-top: 10px;"><input type="submit" value="View Property" class="btn btn-info" /></center>
												</fieldset>
											</form>
										</div>
									</div>
